...
import { createAction, withMatcher, Action, ActionWithPayload } from "../../util/reducer/reducer.utils";
import { USER_ACTION_TYPES } from "./user.types";
import { UserData, AdditionalInformation } from "../../util/Firebase/firebase.utils";
...
export const googleSignInStart = withMatcher(
    (): GoogleSingInStart => createAction(USER_ACTION_TYPES.GOOGLE_SIGN_IN_START));
